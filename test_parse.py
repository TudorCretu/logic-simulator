...
def test_DEVICES_missing_devices_keyword(capfd):
    ...
    assert parser.error_output[0] == "SyntaxError: Expected a keyword 'DEVICES'"
...
def test_DEVICES_missing_connections_keyword_error(capfd):
    ...
    out, err = capfd.readouterr()
    assert parser.error_output[0] == "SyntaxError: Expected a keyword 'CONNECTIONS'"
...
def test_CONNECTIONS_mutliple_errors():
    ...
    assert parser.error_output[0] == "InvalidPortError: Device 'XOR1' does not have port '.I3'"
...
def test_MONITORS_expected_name_error(capfd):
    ...
    assert parser.parse_monitors() is False
    out, err = capfd.readouterr()
    assert parser.error_output[0] == "SyntaxError: Expected a keyword 'MONITORS'"
